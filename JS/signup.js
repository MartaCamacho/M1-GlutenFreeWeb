...
class Signup {
    constructor(){
        ...
        /*this.celiacInput = document.querySelector("#celiac");
        this.notCeliacInput = document.querySelector("#not-celiac");*/
 ...
 handleEmailInput = (event) => {
  ...
  saveData = (event) => {
    ...
    //this.celiacInput.checked = false;
    //this.notCeliacInput.checked = false;
